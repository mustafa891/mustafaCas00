...
const DiceSettings = ({ data, updateData, setData }) => {
  const handleSubmit = () => {
    updateData();
  };
        ...
        <div className="bg-theme border border-rose-300 shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
          ...
          <div className="flex space-x-4">
            <div className="w-1/2">
              ...
              <select
                ...
                name="status"
                value={
                  data.dice_settings?.status !== undefined
                    ? data.dice_settings.status
                    : true
                }
                onChange={(e) =>
                  setData({
            ...
            <div className="w-1/2">
              ...
              <input
                name="max_profit"
                value={data.dice_settings?.max_profit || ""}
                onChange={(e) =>
                  setData({
                    ...data,
                    dice_settings: {
          ...
          <div className="flex space-x-4 mt-3">
            <div className="w-1/2">
              ...
              <input
                name="min_bet"
                value={data.dice_settings?.min_bet || ""}
                onChange={(e) =>
                  setData({
                    ...data,
                    dice_settings: {
            ...
            <div className="w-1/2">
              ...
              <input
                name="max_bet"
                value={data.dice_settings?.max_bet || ""}
                onChange={(e) =>
                  setData({
                    ...data,
                    dice_settings: {
